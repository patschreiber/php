...
when 'debian'
  ...
  if (platform?('debian') && node['platform_version'].to_i >= 9) ||
    ...
    default['php']['packages']         = %w(php7.2-cgi php7.2 php7.2-dev php7.2-cli php-pear php7.2-dom php7.2-gd php7.2-xml php7.2-curl php7.2-zip php7.2-mbstring php7.2-soap)
